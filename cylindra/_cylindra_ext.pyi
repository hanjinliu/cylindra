...
class AnnealingModel:
    ...
    def simulate_batched(self, niter: int = 10000, batch_size: int = 100) -> None: ...
    ...
    def set_reservoir(self, temperature: float, time_constant: float) -> Self: ...
...
class FilamentousAnnealingModel:
    ...
    def temperature(self) -> float: ...
    def set_reservoir(
        self, temperature: float, time_constant: float
...
class CylindricArray:
    ...
    def build_binary_heatmap(
        self, footprint: NDArray[np.bool_]
    ) -> NDArray[np.float32]: ...

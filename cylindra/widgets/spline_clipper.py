...
class SplineClipper(MagicTemplate):
    ...
    clip_length = vfield(nm, label="Clip length (nm)", record=False).with_options(max=20, step=0.1)
    ...
    def __post_init__(self):
        ...
        self._xy_ref = self.xy_canvas.add_infline(pos=[0, 0], degree=0, color="lime", lw=1, ls=":")
        self._yz_line = self.yz_canvas.add_curve([0, 1], [0, 0], color="lime", lw=4)
        self._yz_ref = self.yz_canvas.add_infline(pos=[0, 0], degree=90, color="lime", lw=1, ls=":")
        self._xz_cross = (

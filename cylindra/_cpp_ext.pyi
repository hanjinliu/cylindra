...
class ViterbiGrid2D:
    ...
    def viterbi(self, dist_min: float, dist_max: float, lat_dist_min: float, lat_dist_max: float, /) -> tuple[NDArray[np.int32], float]: ...
    def world_pos(self, lon: int, lat: int, z: int, y: int, x: int, /) -> NDArray[np.float64]: ...
    def all_longitudinal_pairs(self) -> list[tuple[Index, Index]]: ...
    def all_lateral_pairs(self) -> list[tuple[Index, Index]]: ...
    def all_longitudinal_distances(self, states: NDArray[np.int32]) -> NDArray[np.float64]: ...
    def all_lateral_distances(self, states: NDArray[np.int32]) -> NDArray[np.float64]: ...

...
use crate::annealing::{
    graphs::{CylindricGraphTrait, CylindricalGraph, GraphTrait},
    potential::{TrapezoidalPotential2D, LennardJonesLikePotential2D},
...
#[pyclass]
/// A class to perform simulated annealing on a cylindrical lattice.
pub struct CylindricAnnealingModel {
    rng: RandomNumberGenerator,
    optimization_state: OptimizationState,
    graph: CylindricalGraph<TrapezoidalPotential2D>,
    reservoir: Reservoir,
    iteration: usize,
    reject_limit: usize,
}
...
// ----------------------------------------------------------
// Annealing model with Lenard-Jones-like potential
// ----------------------------------------------------------

#[pyclass]
pub struct CylindricAnnealingModelLJ {
    rng: RandomNumberGenerator,
    optimization_state: OptimizationState,
    graph: CylindricalGraph<LennardJonesLikePotential2D>,
    reservoir: Reservoir,
    iteration: usize,
    reject_limit: usize,
}
...
#[pymethods]
impl CylindricAnnealingModelLJ {
    #[new]
    #[pyo3(signature = (seed=0))]
    pub fn new(seed: u64) -> Self {
        let rng = RandomNumberGenerator::new(seed);
